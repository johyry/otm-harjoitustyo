...
public class Kassapaate {
    ...
    public String toString() {
        int euroja = kassassaRahaa/100;
        int sentteja = kassassaRahaa%100;
        
        return "Rahaa kassassa " + euroja + "." + sentteja + " euroa. Maukkaita lounaita myyty " + maukkaat + " kpl ja edullisia " + edulliset + " kpl.";
    }
}